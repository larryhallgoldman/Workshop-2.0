...
. Copy then unpack the downloaded zip file to *Workshop-2.0/demos/demo01/cloud-native-spring*
+
...
*_STS Import Help:_*
+
Select File > Import… Then select Maven > Existing Maven Projects. On the Import Maven Projects page, browse to the /cloud-native-spring directory (e.g. Workshop-2.0/labs/lab01/cloud-native-spring)
...
. In a terminal, change working directory to *Workshop-2.0/demos/demo01/cloud-native-spring*
+
$ cd /Workshop-2.0/demos/demo01/cloud-native-spring
